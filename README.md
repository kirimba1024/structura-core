...
- native Sponge Schematic v1/v2/v3 reading and lossless document copies;
- text SNBT and native Bedrock `.mcstructure` documents;
...
Sponge v1 normalization requires an explicit source DataVersion; native copies do not.
See [additional formats](docs/formats.md) for SNBT, Sponge v1 and optional Bedrock translation.
